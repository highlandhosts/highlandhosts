...
Temporary basic auth has been added to **highland-hosts-guest-website** and **skye-glamping-website** via Next.js middleware. It only activates when `NEXT_PUBLIC_HIGHLAND_HOSTS_ENVIRONMENT=production`.
