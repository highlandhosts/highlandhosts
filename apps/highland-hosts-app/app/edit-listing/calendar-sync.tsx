    ...
    <ScreenContainer>
      ...
      {loading ? (
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <InfoBox variant="info">
            Your Highland Hosts calendar is open by default. We recommend
            setting your Airbnb calendar to {"\u2018"}unavailable by default
            {"\u2019"} so only your open season dates are available across both
            platforms. Bookings made on Highland Hosts are shared with connected
            calendars automatically. Manual blocks you create here stay on
            Highland Hosts only.
          </InfoBox>
